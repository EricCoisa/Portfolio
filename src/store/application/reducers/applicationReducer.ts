...
import { THEME_ADD, CURRENTLANGUAGE_SET, CURRENTTHEME_SET, CURRENTVIEW_SET, LOWPERFORMANCE_SET, type ApplicationState, type ApplicationTypes, VIEWS_ADD } from '../../../types/application';
